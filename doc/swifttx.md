...
This mechanism has been integrated into Bitcore-Node-TESTCURRENCY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/testcurrencyproject/insight-api-testcurrency#web-socket-api](https://github.com/testcurrencyproject/insight-api-testcurrency#web-socket-api) 
* API: [https://github.com/testcurrencyproject/insight-api-testcurrency#swifttx-transactions](https://github.com/testcurrencyproject/insight-api-testcurrency#swifttx-transactions) 
...
By default, the Testcurrency Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Testcurrency Core daemon:
