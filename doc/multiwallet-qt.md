...
In order to support loading of multiple wallets in testcurrency-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is testcurrency.cpp.
...
Changes to testcurrency.cpp
----------------------
testcurrency.cpp is the entry point into testcurrency-qt, and as such, will require some minor modifications to provide hooks for
