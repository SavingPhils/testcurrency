Contributing to Testcurrency Core
============================

The Testcurrency Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Testcurrency Core project, and is not to be
confused with overall Testcurrency Network Protocol consensus changes.

Whether a pull request is merged into Testcurrency Core rests with the project merge
...
Patches that change Testcurrency consensus rules are considerably more involved than
...
Where a patch set proposes to change the Testcurrency consensus, it must have been
...
The project leader is the release manager for each Testcurrency Core release.
