...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Testcurrency Core testcurrency-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  testcurrency-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded testcurrency transaction") + "\n" +
                               "  testcurrency-tx [options] -create [commands]   " + _("Create hex-encoded testcurrency transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded testcurrency transaction
