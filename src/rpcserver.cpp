...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Testcurrency server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Testcurrency server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Testcurrency features */
        {"testcurrency", "masternode", &masternode, true, true, false},
        {"testcurrency", "listmasternodes", &listmasternodes, true, true, false},
        {"testcurrency", "getmasternodecount", &getmasternodecount, true, true, false},
        {"testcurrency", "masternodeconnect", &masternodeconnect, true, true, false},
        {"testcurrency", "masternodecurrent", &masternodecurrent, true, true, false},
        {"testcurrency", "masternodedebug", &masternodedebug, true, true, false},
        {"testcurrency", "startmasternode", &startmasternode, true, true, false},
        {"testcurrency", "createmasternodekey", &createmasternodekey, true, true, false},
        {"testcurrency", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"testcurrency", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"testcurrency", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"testcurrency", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"testcurrency", "getmasternodescores", &getmasternodescores, true, true, false},
        {"testcurrency", "mnbudget", &mnbudget, true, true, false},
        {"testcurrency", "preparebudget", &preparebudget, true, true, false},
        {"testcurrency", "submitbudget", &submitbudget, true, true, false},
        {"testcurrency", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"testcurrency", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"testcurrency", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"testcurrency", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"testcurrency", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"testcurrency", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"testcurrency", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"testcurrency", "checkbudgets", &checkbudgets, true, true, false},
        {"testcurrency", "mnsync", &mnsync, true, true, false},
        {"testcurrency", "spork", &spork, true, true, false},
        {"testcurrency", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"testcurrency", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use testcurrencyd, or the -server option to testcurrency-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> testcurrency-cli " + methodname + " " + args + "\n";
}
