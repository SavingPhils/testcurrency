...
/** Utility functions used by the Testcurrency Qt UI.
 */
namespace GUIUtil
{
...
// Render Testcurrency addresses in monospace font
...
// Parse "testcurrency:" URI into recipient object, return true on successful parsing
