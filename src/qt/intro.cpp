...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Testcurrency Core"),
     ...
     * override -datadir in the testcurrency.conf file in the default data directory
     * (to be consistent with testcurrencyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
