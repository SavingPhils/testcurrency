                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Testcurrency Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Testcurrency address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and testcurrency: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTEST"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Testcurrency Core"), this);
    aboutAction->setStatusTip(tr("Show information about Testcurrency Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Testcurrency"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Testcurrency addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Testcurrency addresses"));
    ...
    openAction->setStatusTip(tr("Open a Testcurrency: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Testcurrency Core help message to get a list with possible Testcurrency command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Testcurrency Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Testcurrency network", "", count));
}
...
{
    QString strTitle = tr("Testcurrency Core"); // default title
